...
public class TeXFormulaSettingsParserA implements TeXFormulaSettingsParser {

	private Element root;

	public TeXFormulaSettingsParserA(AssetManager assetManager) throws ResourceParseException, IOException {
		this(assetManager.open(RESOURCE_NAME), RESOURCE_NAME);
	}

	public TeXFormulaSettingsParserA(AssetManager assetManager, String name) throws ResourceParseException, IOException {
		this(assetManager.open(name), name);
	}

	public TeXFormulaSettingsParserA(InputStream file, String name)

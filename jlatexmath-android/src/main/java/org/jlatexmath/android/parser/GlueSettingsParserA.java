...
public class GlueSettingsParserA implements GlueSettingsParser {
    ...
    public GlueSettingsParserA(AssetManager assetManager) throws ResourceParseException {
	    ...
	    root = factory.newDocumentBuilder().parse(assetManager.open(RESOURCE_NAME)).getDocumentElement();
	    parseGlueTypes();

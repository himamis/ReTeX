...
public class PngSerializer {
	...
	public static void save(MathFormula formula, String filename) throws IOException {
		...
		TeXIcon renderer = texFormula.new TeXIconBuilder().setStyle(TeXConstants.STYLE_DISPLAY).setSize(18).build();
		BufferedImage image = new BufferedImage(
				renderer.getIconWidth(), renderer.getIconHeight(), BufferedImage.TYPE_INT_ARGB);
		Graphics2D g2 = image.createGraphics();
		IconHelper.createIcon(renderer).paintIcon(new JLabel(), g2, 0, 0); // component can't be null

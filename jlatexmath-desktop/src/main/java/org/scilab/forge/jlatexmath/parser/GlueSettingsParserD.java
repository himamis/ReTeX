...
public class GlueSettingsParserD implements GlueSettingsParser {
    ...
    public GlueSettingsParserD() throws ResourceParseException {
        try {
            setTypeMappings();
            setStyleMappings();
	    ...
	    root = factory.newDocumentBuilder().parse(ClassLoader.getSystemResourceAsStream(RESOURCE_NAME)).getDocumentElement();
	    parseGlueTypes();

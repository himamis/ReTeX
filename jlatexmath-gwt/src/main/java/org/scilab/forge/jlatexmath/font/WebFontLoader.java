...
public class WebFontLoader {
	...
	private void initWebFontConfig() {
		setupWebFontConfig();
	}

	private native void setupWebFontConfig() /*-{
												var that = this;
												WebFontConfig = {
												loading: function() {},
												active: function() {},
												inactive: function() {},
												fontloading: $entry(that.@org.scilab.forge.jlatexmath.font.WebFontLoader::fireFontLoadingEvent(Ljava/lang/String;Ljava/lang/String;)),
												fontactive: $entry(that.@org.scilab.forge.jlatexmath.font.WebFontLoader::fireFontActiveEvent(Ljava/lang/String;Ljava/lang/String;)),
												fontinactive: $entry(that.@org.scilab.forge.jlatexmath.font.WebFontLoader::fireFontInactiveEvent(Ljava/lang/String;Ljava/lang/String;))
												};
												}-*/;

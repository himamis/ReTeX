...
public class KeyListenerAdapter implements View.OnKeyListener {
    ...
    private static com.himamis.retex.editor.desktop.event.KeyEvent wrapEvent(KeyEvent keyEvent) {
        int keyCode = keyEvent.getKeyCode();
        char charCode = (char) keyEvent.getUnicodeChar();
        int modifiers = getModifiers(keyEvent);
        return new com.himamis.retex.editor.desktop.event.KeyEvent(keyCode, modifiers, charCode);
    }

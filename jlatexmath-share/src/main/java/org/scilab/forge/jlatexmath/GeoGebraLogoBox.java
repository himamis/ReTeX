...
public class GeoGebraLogoBox extends Box {
    ...
    private static final Color gray = GRAPHICS_FACTORY.createColor(102, 102, 102);
    
    private static final Color blue = GRAPHICS_FACTORY.createColor(153, 153, 255);

    private static final BasicStroke st = GRAPHICS_FACTORY.createBasicStroke(3.79999995f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 4f);
    		
    private static final BasicStroke stC = GRAPHICS_FACTORY.createBasicStroke(1f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 4f);

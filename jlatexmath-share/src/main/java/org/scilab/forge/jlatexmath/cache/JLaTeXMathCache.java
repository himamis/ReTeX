...
public final class JLaTeXMathCache {
    ...
    private static final Transform identity = GRAPHICS_FACTORY.createTransform();
    ...
    private static SoftReference<CachedImage> makeImage(CachedTeXFormula cached) throws ParseException {
        ...
        Image image = GRAPHICS_FACTORY.createImage(icon.getIconWidth(), icon.getIconHeight(), Image.TYPE_INT_ARGB);

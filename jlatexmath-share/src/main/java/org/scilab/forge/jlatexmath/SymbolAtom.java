...
public class SymbolAtom extends CharSymbol {
    ...
    static {
        symbols = FactoryProvider.INSTANCE.getParserFactory().createTeXSymbolParser(TeXSymbolParser.RESOURCE_NAME).readSymbols();
	...
	TeXSymbolParser tsp = FactoryProvider.INSTANCE.getParserFactory().createTeXSymbolParser(name);

...
public class TeXFormula {
	...
	private static final GraphicsFactory GRAPHICS_FACTORY = FactoryProvider.INSTANCE
			.getGraphicsFactory();
	private static final ParserFactory PARSER_FACTORY = FactoryProvider.INSTANCE.getParserFactory();
	...
	static {
		// character-to-symbol and character-to-delimiter mappings
		TeXFormulaSettingsParser parser = PARSER_FACTORY.createTeXFormulaSettingsParser(
	...
	public static void addSymbolMappings(String name)
		...
		TeXFormulaSettingsParser tfsp = PARSER_FACTORY.createTeXFormulaSettingsParser(name);
	...
	public static void setDefaultDPI() {
		// TODO: MY GraphicsEnviroment dpi target?
	...
	public void createImage(String format, int style, float size, String out,
		...
		Image image = GRAPHICS_FACTORY.createImage(w, h,
				transparency ? Image.TYPE_INT_ARGB : Image.TYPE_INT_RGB);
		...
		g2.dispose();
		throw new UnsupportedOperationException("Create image is not supported!");
		/*try {
			//FileImageOutputStream imout = new FileImageOutputStream(new File(
			//		out));
			// TODO: MY image io/ casting
			//ImageIO.write((BufferedImage) image, format, imout);
			//imout.flush();
			//imout.close();
	...
	public static Image createBufferedImage(String formula, int style,
			float size, Color fg, Color bg) throws ParseException {

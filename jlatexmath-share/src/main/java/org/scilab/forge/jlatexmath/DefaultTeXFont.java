...
public class DefaultTeXFont implements TeXFont {
    ...
    static {
        TeXFontParser parser = PARSER_FACTORY.createTeXFontParser(TeXFontParser.RESOURCE_NAME);
        //load LATIN block
        ...
        int muFontId = generalSettings.get(TeXFontParser.MUFONTID_ATTR).intValue();
        if (muFontId < 0 || muFontId >= fontInfo.length || fontInfo[muFontId] == null)
            throw new XMLResourceParseException(
                TeXFontParser.RESOURCE_NAME,
                TeXFontParser.GEN_SET_EL,
                TeXFontParser.MUFONTID_ATTR,
    ...
    public static void addTeXFontDescription(String name) throws ResourceParseException {
        TeXFontParser dtfp = PARSER_FACTORY.createTeXFontParser(name);
    ...
    public int getMuFontId() {
        return generalSettings.get(TeXFontParser.MUFONTID_ATTR).intValue();
    }
    ...
    public float getSpace(int style) {
        int spaceFontId = generalSettings.get(TeXFontParser.SPACEFONTID_ATTR).intValue();
